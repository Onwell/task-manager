...
<body>
    ...
    <header>
        <div class="container">
            <nav class="navbar">
                <a href="index.php" class="logo">TASK <span>MANAGER</span></a>
                <ul class="nav-links">
                </ul>
                <?php if(isset($_SESSION['user_id'])): ?>
                    <a href="sign-in.php" class="btn">Get Started</a>
                <?php else: ?>
                    <a href="sign-in.php" class="btn">Get Started</a>
                <?php endif; ?>
            </nav>
    ...
    <section class="hero-section">
        <div class="hero-container">
            <div class="hero-content">
                ...
                <a href="<?php echo isset($_SESSION['user_id']) ? 'dashboard.php' : 'sign-in.php'; ?>" class="btn">Get Started</a>
            </div>
            <div class="hero-image">
                <img src="images/task-manager-hero.jpg" alt="Task Manager Illustration" onerror="this.src='https://via.placeholder.com/500x400/FFF0D3/E5A624?text=Task+Manager'">
            </div>
        </div>
    </section>
    ...
    <section class="cta">
        <div class="container">
            ...
            <a href="create-account.php" class="btn">Sign Up Free</a>
            ...
            <div class="footer-container">
                ...
                <div class="footer-column">
                    ...
                    <ul>
                        ...
                        <li><a href="sign-in.php">Get Started</a></li>
                    </ul>
                </div>
                <div class="footer-column">
                    <h3>Resources</h3>
                ...
                <div class="footer-column">
                    ...
                    <ul>
                        ...
                        <li><i class="fas fa-phone"></i> +263 777 224 660</li>
                        <li><i class="fas fa-envelope"></i> o.masaraure@gmail.com</li>
                    </ul>
                </div>
            </div>
            <div class="copyright">
                <p>&copy; <?php echo date('Y'); ?> Task Manager. All rights reserved. / <a href="#">Smug Solutions Pvt Ltd.</a></p>
            </div>
        </div>
    </footer>
