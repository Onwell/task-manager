			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="register.php" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Name is required">
						<input class="input100" type="text" name="text" placeholder="Full name" value="<?php echo isset($_SESSION['form_data']['name']) ? $_SESSION['form_data']['name'] : ''; ?>">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text" name="email" placeholder="Email" value="<?php echo isset($_SESSION['form_data']['email']) ? $_SESSION['form_data']['email'] : ''; ?>">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
